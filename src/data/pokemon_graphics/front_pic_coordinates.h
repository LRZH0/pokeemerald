...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_DHELMISE]    = { .size = MON_COORDS_SIZE(24, 56), .y_offset =  6 },
    ...
    [SPECIES_SQUID]       = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
    ...
    [SPECIES_REGIELEKI]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_REGIDRAGO]   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
