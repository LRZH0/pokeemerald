const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_RAZOR_WIND] =
    {
        .effect = EFFECT_RAZOR_WIND, // High crit ratio
        .power = 80,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_TWINEEDLE] =
    {
        .effect = EFFECT_TWINEEDLE, // poison chance on each hit
        .power = 25,
        .type = TYPE_BUG,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_RAPID_SPIN] =
    {
        .effect = EFFECT_RAPID_SPIN, // +1 Speed
        .power = 40,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 40,
    ...
    [MOVE_HOWL] =
    {
        ...
        .pp = 40,
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_USER, // User & Ally
        .priority = 0,
        .flags = FLAG_SNATCH_AFFECTED,
    },
    ...
    [MOVE_VOLT_TACKLE] =
    {
        .effect = EFFECT_DOUBLE_EDGE, // + Paralysis
        .power = 120,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
        .pp = 15,
