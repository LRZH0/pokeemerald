...
const u8 gText_BattleArcadeAssessmentSymbol[] = _("Battle Arcade - Versatility Symbol");
...
const u8 gText_BattleArcade2[] = _("BATTLE ARCADE");
...
const u8 gText_BattleArcadeDesc[] = _("Spin the wheel for battle conditions!\nYour versatility will be tested.");
...
const u8 gText_SingleBattleStreakResults[] = _("{PLAYER}'s Single Battle Streak Results");
const u8 gText_DoubleBattleStreakResults[] = _("{PLAYER}'s Double Battle Streak Results");
