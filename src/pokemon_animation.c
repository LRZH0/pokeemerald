...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_DHELMISE]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    ...
    [SPECIES_MAGNEZONE]  = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SQUID]      = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_REGIDRAGO]  = BACK_ANIM_GROW_STUTTER,
