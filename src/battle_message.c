...
static const u8 sText_PkmnsXLoseHPALittle[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\ndamaged its HP a little!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_PKMNSXLOSEHPALITTLE - BATTLESTRINGS_TABLE_START] = sText_PkmnsXLoseHPALittle,
};
